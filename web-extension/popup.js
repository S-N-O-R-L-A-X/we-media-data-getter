...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    async function init() {
        ...
        } else if (url.startsWith('https://channels.weixin.qq.com/micro/content/post/list') || url.startsWith('https://channels.weixin.qq.com/platform/post/list')) {
